...
namespace datetimeVeMathSinifi
{
    internal class Program
    {
        static void Main(string[] args)
        {
            Console.WriteLine(DateTime.Now); // Günün tarihini verir
            ...
            Console.WriteLine(Math.Log(9)); // 9'un e tabanındaki logortimik karşılığını getirir.
